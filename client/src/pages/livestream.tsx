...
export default function LiveStream() {
  ...
  const handleShareStream = () => {
    navigator.clipboard.writeText("https://gamechanger.com/stream/live-1234");
        ...
        <div className="lg:col-span-2">
          <Card className="mb-6">
            <CardHeader className="pb-3">
              <CardTitle>{isStreaming ? "Live Broadcast" : "Stream Preview"}</CardTitle>
              <CardDescription>
                {isStreaming 
            ...
            <CardContent>
              <div className="aspect-video overflow-hidden rounded-md bg-black relative">
                <VideoPlayer 
                  ...
                  isLive={isStreaming}
                  title={isStreaming ? "Wildcats vs. Eastside Lions" : undefined}
                />
                ...
                {showScoreboard && isStreaming && (
                  <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-black/80 text-white px-4 py-2 rounded-full">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="text-sm font-medium border-l border-white/30 pl-3 ml-2">Q4 2:45</div>
                    </div>
                  </div>
                )}
              </div>
              ...
              {isStreaming && (
                <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
                  <Button
                    ...
                    className={showChat ? "bg-[#FF6B00] hover:bg-orange-700" : ""}
                  ...
                  <Button
                    ...
                    className={showStats ? "bg-[#FF6B00] hover:bg-orange-700" : ""}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-neutral-500">Higher quality uses more data and requires better internet connection.</p>
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-medium">AutoStream Tracking</label>
                    <select className="w-full rounded-md border border-input bg-background px-3 py-2">
                      <option>Enabled</option>
                      <option>Disabled</option>
                    </select>
                    <p className="text-xs text-neutral-500">AutoStream automatically follows the action on the court.</p>
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Record Stream</label>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="record-stream" className="rounded border-neutral-300" defaultChecked />
                      <label htmlFor="record-stream" className="text-sm">Save stream for later viewing</label>
                    </div>
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Stream Privacy</label>
                    <select className="w-full rounded-md border border-input bg-background px-3 py-2">
                      <option>Public - Anyone can watch</option>
                      <option>Team Only - Only team members can watch</option>
                      <option>Private - Only people with the link can watch</option>
                    </select>
                  </div>
                </CardContent>
              </Card>
                  ...
                  {isStreaming ? (
                    <div className="space-y-4">
                      <div className="p-3 bg-neutral-50 rounded-md flex items-center justify-between">
                        ...
                        <span className="text-xs text-neutral-500">Joined 5m ago</span>
                      </div>
                      ...
                      <div className="p-3 bg-neutral-50 rounded-md flex items-center justify-between">
                        ...
                        <span className="text-xs text-neutral-500">Joined 3m ago</span>
                      </div>
                      ...
                      <div className="p-3 bg-neutral-50 rounded-md flex items-center justify-between">
                        ...
                        <span className="text-xs text-neutral-500">Joined 1m ago</span>
                      </div>
                    ...
                    <div className="p-8 text-center text-neutral-500">
                      ...
                      <p>Your audience will appear here once you start streaming.</p>
                    </div>
                  )}
                </CardContent>
              </Card>
